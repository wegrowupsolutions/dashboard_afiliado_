...
const predefinedAgents: Agent[] = [
  {
    ...
    personality:
      "Amigável, amorosa com os pets, detalhista e conhecedora de animais",
  ...
  const sendAgentDataToWebhook = async (agentData: AgentFormValues) => {
    try {
      const response = await fetch(
        "https://webhook.serverwegrowup.com.br/webhook/config_agent",
        {
          method: "POST",
          headers: {
      ...
      toast({
        ...
        description:
          "Os dados foram salvos localmente, mas houve um problema ao sincronizar com o sistema externo.",
        variant: "destructive",
      })
      return false
    }
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          {agents.find((agent) => agent.isActive)?.company} •{" "}
                          {agents.find((agent) => agent.isActive)?.industry}
                        </p>
                      </div>
                    ...
                    <div className="space-y-2 text-sm">
                      <p>
                        ...
                        {agents.find((agent) => agent.isActive)?.objective}
                      </p>
                      <p>
                        <span className="font-medium">Personalidade:</span>{" "}
                        {agents.find((agent) => agent.isActive)?.personality}
                      </p>
                    </div>
                    <Button
                      variant="outline"
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {agents.map((agent) => (
                <Card
                  key={agent.id}
                  className={`border ${agent.isActive ? "border-primary" : ""}`}
                >
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Qual é o nicho ou indústria para este prompt?
                      </FormLabel>
                      <FormControl>
                        <Input
                          placeholder="Ex: Pet Shop, Imobiliária, Restaurante"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Ex: Pet Paradise, Casa & Lar, Sabor Gourmet"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Qual é o principal produto ou serviço oferecido?
                      </FormLabel>
                      <FormControl>
                        <Textarea
                      ...
                      <FormDescription>
                        Os produtos ou serviços que a empresa oferece aos
                        clientes.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Qual é a estratégia para atendimento e vendas?
                      </FormLabel>
                      <FormControl>
                        <Textarea
                      ...
                      <FormDescription>
                        A abordagem que o agente deve utilizar para atender e
                        vender.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Ex: Nina, Carlos, Marina"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                        O nome que o assistente virtual usará para se
                        identificar.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Quais são os principais traços de personalidade do
                        agente?
                      </FormLabel>
                      <FormControl>
                        <Textarea
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Qual é o objetivo central do agente?
                      </FormLabel>
                      <FormControl>
                        <Textarea
                      ...
                      <FormDescription>
                        O propósito principal do agente na interação com
                        clientes.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <DialogFooter>
                  <Button
                    type="button"
                    variant="outline"
                    onClick={handleCloseNewAgentDialog}
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {selectedAgent.company} • {selectedAgent.industry}
                    </p>
                  </div>
        ...
        <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Tem certeza que deseja excluir este agente? Esta ação não pode
                ser desfeita.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
